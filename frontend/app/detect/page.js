            ...
            <div className="text-center">
              <div className="inline-block">
                <span className="inline-block relative">
                  ...
                  <h1 className="text-4xl md:text-5xl font-bold bg-gradient-to-r from-blue-700 to-blue-500 dark:from-blue-500 dark:to-accent bg-clip-text text-transparent pb-2">
                    Deteksi Retinopati
                  </h1>
                </span>
              ...
              <p className="mt-4 text-gray-600 dark:text-gray-300 max-w-2xl mx-auto">
                Unggah gambar retina Anda untuk analisis menggunakan teknologi kecerdasan buatan kami.
              </p>
            </div>
          </div>
              ...
              {[
                {
                  ...
                  title: "Keamanan Data",
                  description: "Semua data yang diunggah dilindungi dengan enkripsi tingkat tinggi"
                },
                {
                  icon: (
                    <svg xmlns="http://www.w3.org/2000/svg" className="h-7 w-7" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                ...
                },
                {
                  ...
                  title: "Rekam Medis",
                  description: "Riwayat hasil deteksi tersimpan dalam akun Anda"
                }
              ].map((card, index) => (
                <div 
                  key={index} 
                ...
                >
                  ...
                  <h3 className="text-lg font-bold text-gray-800 dark:text-white mb-2">{card.title}</h3>
